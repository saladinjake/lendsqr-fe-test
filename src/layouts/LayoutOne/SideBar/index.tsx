     ...
     >
       <Box height={sidebarOpen ? "90px" : "110px"} width="90%" mx="auto">
         <Flex
           ...
           container
         >
           {sidebarOpen ? <><Svg.SampleLogo />

             <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="150.000000pt" height="20.000000pt" viewBox="0 0 300.000000 44.000000" preserveAspectRatio="xMidYMid meet">

          <g transform="translate(0.000000,44.000000) scale(0.100000,-0.100000)" fill="#40196D" stroke="none">
